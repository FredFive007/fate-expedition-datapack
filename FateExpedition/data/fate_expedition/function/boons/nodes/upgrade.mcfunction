...
tellraw @a [{"text":"[1] 稳健开局：全队+4最大生命","color":"blue","bold":true,"underlined":true,"click_event":{"action":"run_command","command":"/trigger fe_boon set 1"},"hover_event":{"action":"show_text","value":{"text":"死亡后保留，卸载时移除。"}}}]
tellraw @a [{"text":"[2] 轻快步伐：全队+10%移动速度","color":"aqua","bold":true,"underlined":true,"click_event":{"action":"run_command","command":"/trigger fe_boon set 2"},"hover_event":{"action":"show_text","value":{"text":"死亡后保留，卸载时移除。"}}}]
